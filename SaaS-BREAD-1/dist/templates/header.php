...
<header>
    <nav class="flex items-center justify-between flex-wrap bg-black p-6 fixed w-full z-10 top-0">
        ...
        <div class="w-full flex-grow lg:flex lg:flex lg:items-center lg:w-auto hidden lg:block pt-6 lg:pt-0"
             id="nav-content">
            ...
            <ul class="list-reset justify-end lg:flex flex-1 items-center">
                <li class="mr-3 ">
                    <a class="inline-block border border-1 border-gray-600 py-2 px-4 rounded text-white transition-colors duration-500 ease-in-out no-underline hover:text-black hover:bg-gray-400 hover:text-underline py-2 px-4"
                       href="#">About</a>
                </li>
                <li class="mr-3 ">
                    <a class="inline-block py-2 px-4 rounded text-white transition-colors duration-500 ease-in-out no-underline hover:text-black hover:bg-gray-400 hover:text-underline py-2 px-4"

            ...
            <table class="table-auto w-full border border-blue-700">
                ...
                while ($aUser = $statement->fetch()) {
                    ...
                    <tr class="hover:bg-blue-100 border-blue-700 border border-bottom-1 py-1 my-1">
                        ...
                        <td class="p-1 m-1">
                            <a href="/saas_bread/users/read.php?id=<?= $id ?>"
                               class="m-0 p-1 mr-2 text-bold
                                      border border-1 border-blue-400 rounded
                                      bg-blue-100 text-blue-700
                                      hover:bg-blue-500 hover:text-white">Read</a>
                            <a href="/saas_bread/users/edit.php?id=<?= $id ?>"
                               class="m-0 p-1 mr-2 text-bold
                                      border border-1 border-blue-400 rounded
                                      bg-blue-100 text-blue-700
                                      hover:bg-blue-500 hover:text-white">Edit</a>
                            <a href="/saas_bread/users/delete.php?id=<?= $id ?>"
                               class="m-0 p-1 mr-2 text-bold
                                      border border-1 border-blue-400 rounded
                                      bg-blue-100 text-blue-700
                                      hover:bg-blue-500 hover:text-white">Delete</a>
                        </td>
                    </tr>
                    <?php
                }

...
<div class="wb-store-details">
	...
	<div class="wb-store-properties"
		...
		<div class="wb-store-desc" style="max-width: 768px;">
			...
			<div style="white-space: pre-line;"><?php echo $this->noPhp(tr_($item->description)); ?></div>
		</div>
		<?php endif; ?>
...
<script type="text/javascript">
	$(function() {
		require(['store/js/StoreDetails'], function(app) { app.init('<?php echo $elementId; ?>', '<?php echo $item->id; ?>', '<?php echo $cartUrl; ?>', <?php echo json_encode($jsImages); ?>); });
		$(window).on('resize', function() {
			$('#<?php echo $elementId; ?> .wb-store-properties').css('margin-left', ($('#<?php echo $elementId; ?> .wb-store-imgs-block').outerWidth(true) + 5) + 'px');
		});
